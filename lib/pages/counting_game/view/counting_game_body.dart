...
class CountingGameBody extends StatefulWidget {
  const CountingGameBody({super.key});

  @override
  State<CountingGameBody> createState() => _CountingGameBodyState();
}

class _CountingGameBodyState extends State<CountingGameBody> {
